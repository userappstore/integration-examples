const authorizedAppStores = require('@userappstore/express-authorized-app-stores')
...
app.use(route((router) => {
  ...
  app.use((req, res, next) => {
    // since requests are unverified tag req information manually
